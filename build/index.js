...
<main class="wrap">
  ...
  <footer class="gallery-footer">
    ...
    <a class="footer-credit" href="https://github.com/pvollenweider/ssgg" target="_blank" rel="noopener">SSGG</a>
  </footer>
</main>
...
legalOverlay.addEventListener('click', e => {
  if (e.target === legalOverlay) legalOverlay.style.display = 'none';
});
