// core/config.js — configuration loading and gallery discovery
import fs   from 'fs';
import path from 'path';

import { SRC_ROOT, BUILD_CFG_PATH } from '../infra/fs.js';
import { titleFromSlug, validateConfig } from '../build/utils.js';
